...
.nav-item:hover{background:#161616;color:#999;}
      ...
      <div className="f" style={{display:"flex",minHeight:"100vh",background:"#0a0a0a"}}>
          ...
          <div style={{borderTop:"1px solid #141414",paddingTop:12}}>
            <div style={{display:"flex",alignItems:"center",gap:8,padding:"6px 10px",marginBottom:6}}>
              ...
              <div style={{overflow:"hidden"}}>
                ...
                <p style={{fontSize:10,color:"#444",margin:0}}>Admin</p>
              </div>
            </div>
        ...
        <div style={{flex:1,marginLeft:0,display:"flex",flexDirection:"column"}}>
          <header style={{padding:"12px 16px",borderBottom:"1px solid #141414",position:"sticky",top:0,background:"#0a0a0a",zIndex:30,display:"flex",alignItems:"center",gap:12}}>
            ...
            <p style={{fontSize:13,fontWeight:500,color:"#666",margin:0,flex:1}}>{NAV.find(n=>n.id===tab)?.label}</p>
          ...
          <main style={{flex:1,padding:"24px",overflowY:"auto"}}>
            ...
            {tab==="overview" && (
              <div style={{display:"flex",flexDirection:"column",gap:20}}>
                <div className="au">
                  ...
                  <p style={{fontSize:13,color:"#444",margin:0}}>Here's what's happening today</p>
                </div>
                ...
                <div className="au2 card" style={{overflow:"hidden"}}>
                  ...
                  {interns.length===0 ? <p style={{padding:"20px 16px",color:"#333",fontSize:13,margin:0}}>No interns yet.</p>
                  : interns.map((u,i)=>(
              ...
              <div style={{display:"flex",flexDirection:"column",gap:16}}>
                ...
                <div className="au1 card" style={{overflow:"hidden"}}>
                  <div style={{padding:"12px 16px",borderBottom:"1px solid #141414"}}>
                    <p style={{fontSize:13,fontWeight:500,color:"#fff",margin:0}}>All Users <span style={{color:"#444"}}>({users.length})</span></p>
                  </div>
                  {users.map((u,i)=>(
                    <div key={i} className="row">
                      <Av name={u.name}/>
                      ...
                      <select value={u.role} onChange={e=>changeRole(u.uid,e.target.value)}
                        style={{background:"#161616",border:"1px solid #222",borderRadius:6,padding:"4px 8px",color:"#888",fontSize:12,cursor:"pointer"}}>
            ...
            {tab==="visits" && (
              <div style={{display:"flex",flexDirection:"column",gap:16}}>
                ...
                <div className="au1 card" style={{overflow:"hidden"}}>
                  <div style={{padding:"12px 16px",borderBottom:"1px solid #141414"}}>
                    <p style={{fontSize:13,fontWeight:500,color:"#fff",margin:0}}>Visit Log <span style={{color:"#444"}}>({visits.length})</span></p>
                  </div>
